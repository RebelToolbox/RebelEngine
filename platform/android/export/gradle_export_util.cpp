...
Error _create_project_name_strings_files(
    ...
    store_string_at_path(
        "res://android/project/res/values/project_name_string.xml",
        processed_default_xml_string
    );

    // Searches the Gradle project res/ directory to find all supported locales
    DirAccessRef da = DirAccess::open("res://android/project/res");
    if (!da) {
        if (OS::get_singleton()->is_stdout_verbose()) {
    ...
    while (true) {
        ...
        String locale_directory =
            "res://android/project/res/" + file + "/project_name_string.xml";
