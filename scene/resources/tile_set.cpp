...
void TileSet::tile_set_material(
    int p_id,
...
void TileSet::autotile_set_subtile_priority(
    int p_id,
...
void TileSet::autotile_set_z_index(
    int p_id,
    const Vector2& p_coord,
    int p_z_index
) {
...
Vector2 TileSet::autotile_get_subtile_for_bitmask(
    int p_id,
    uint16_t p_bitmask,
    ...
    for (Map<Vector2, uint32_t>::Element* E =
        ...
        if (tile_map[p_id].autotile_data.bitmask_mode == BITMASK_2X2) {
            mask |=
                (BIND_IGNORE_TOP | BIND_IGNORE_LEFT | BIND_IGNORE_CENTER
...
Vector2 TileSet::atlastile_get_subtile_by_priority(
    int p_id,
    const Node* p_tilemap_node,
    const Vector2& p_tile_location
) {
    ...
    const Vector2 spacing(
        autotile_get_spacing(p_id),
        autotile_get_spacing(p_id)
    );
    const Vector2 coord =
        tile_get_region(p_id).size / (autotile_get_size(p_id) + spacing);

    List<Vector2> coords;
    for (int x = 0; x < coord.x; x++) {
        for (int y = 0; y < coord.y; y++) {
            for (int i = 0;
                 i < autotile_get_subtile_priority(p_id, Vector2(x, y));
                 i++) {
...
void TileSet::tile_set_shape_transform(
    int p_id,
    int p_shape_id,
...
void TileSet::tile_set_shape_offset(
    int p_id,
    int p_shape_id,
...
void TileSet::tile_set_shape_one_way(
    int p_id,
    int p_shape_id,
...
void TileSet::tile_set_shape_one_way_margin(
    int p_id,
    int p_shape_id,
    float p_margin
) {
...
Ref<OccluderPolygon2D> TileSet::autotile_get_light_occluder(
    int p_id,
    const Vector2& p_coord
) const {
    ERR_FAIL_COND_V_MSG(
...
void TileSet::tile_set_navigation_polygon_offset(
    int p_id,
    const Vector2& p_offset
) {
    ERR_FAIL_COND_MSG(
...
const Map<Vector2, Ref<OccluderPolygon2D>>& TileSet::
...
void TileSet::autotile_set_navigation_polygon(
    ...
    if (p_navigation_polygon.is_null()) {
        ...
        tile_map[p_id].autotile_data.navpoly_map[p_coord] =
            p_navigation_polygon;
    }
}

Ref<NavigationPolygon> TileSet::autotile_get_navigation_polygon(
    int p_id,
    const Vector2& p_coord
) const {
    ERR_FAIL_COND_V_MSG(
...
const Map<Vector2, Ref<NavigationPolygon>>& TileSet::
...
void TileSet::_tile_set_shapes(int p_id, const Array& p_shapes) {
    ...
    for (int i = 0; i < p_shapes.size(); i++) {
        ...
        if (p_shapes[i].get_type() == Variant::OBJECT) {
            ...
            ERR_CONTINUE_MSG(
                true,
                "Expected an array of objects or dictionaries for "
                "tile_set_shapes."
            );
        }
...
void TileSet::_bind_methods() {
    ...
    ClassDB::bind_method(
        D_METHOD("autotile_clear_bitmask_map", "id"),
        &TileSet::autotile_clear_bitmask_map
    );
    ClassDB::bind_method(
        D_METHOD("autotile_set_icon_coordinate", "id", "coord"),
        &TileSet::autotile_set_icon_coordinate
    );
    ClassDB::bind_method(
        D_METHOD("autotile_get_icon_coordinate", "id"),
    ...
    ClassDB::bind_method(
        D_METHOD("autotile_get_subtile_priority", "id", "coord"),
    ...
    ClassDB::bind_method(
        D_METHOD("autotile_get_z_index", "id", "coord"),
    ...
    ClassDB::bind_method(
        D_METHOD("autotile_get_light_occluder", "id", "coord"),
    ...
    ClassDB::bind_method(
        D_METHOD("autotile_get_bitmask", "id", "coord"),
        &TileSet::autotile_get_bitmask
    );
    ClassDB::bind_method(
        D_METHOD("autotile_set_bitmask_mode", "id", "mode"),
        &TileSet::autotile_set_bitmask_mode
    );
    ClassDB::bind_method(
        D_METHOD("autotile_get_bitmask_mode", "id"),
        &TileSet::autotile_get_bitmask_mode
    );
    ClassDB::bind_method(
        D_METHOD("autotile_set_spacing", "id", "spacing"),
        &TileSet::autotile_set_spacing
    );
    ClassDB::bind_method(
        D_METHOD("autotile_get_spacing", "id"),
        &TileSet::autotile_get_spacing
    );
    ClassDB::bind_method(
        D_METHOD("autotile_set_size", "id", "size"),
        &TileSet::autotile_set_size
    );
    ClassDB::bind_method(
        D_METHOD("autotile_get_size", "id"),
        &TileSet::autotile_get_size
    );
    ClassDB::bind_method(
        D_METHOD("tile_set_name", "id", "name"),
        &TileSet::tile_set_name
    );
    ClassDB::bind_method(
        D_METHOD("tile_get_name", "id"),
        &TileSet::tile_get_name
    );
    ClassDB::bind_method(
        D_METHOD("tile_set_texture", "id", "texture"),
        &TileSet::tile_set_texture
    );
    ClassDB::bind_method(
        D_METHOD("tile_get_texture", "id"),
        &TileSet::tile_get_texture
    );
    ClassDB::bind_method(
        D_METHOD("tile_set_normal_map", "id", "normal_map"),
        &TileSet::tile_set_normal_map
    );
    ClassDB::bind_method(
        D_METHOD("tile_get_normal_map", "id"),
        &TileSet::tile_get_normal_map
    );
    ClassDB::bind_method(
        D_METHOD("tile_set_material", "id", "material"),
        &TileSet::tile_set_material
    );
    ClassDB::bind_method(
        D_METHOD("tile_get_material", "id"),
        &TileSet::tile_get_material
    );
    ClassDB::bind_method(
        D_METHOD("tile_set_modulate", "id", "color"),
        &TileSet::tile_set_modulate
    );
    ClassDB::bind_method(
        D_METHOD("tile_get_modulate", "id"),
    ...
    ClassDB::bind_method(
        D_METHOD("tile_get_texture_offset", "id"),
        &TileSet::tile_get_texture_offset
    );
    ClassDB::bind_method(
        D_METHOD("tile_set_region", "id", "region"),
        &TileSet::tile_set_region
    );
    ClassDB::bind_method(
        D_METHOD("tile_get_region", "id"),
        &TileSet::tile_get_region
    );
    ClassDB::bind_method(
        D_METHOD("tile_set_shape", "id", "shape_id", "shape"),
        &TileSet::tile_set_shape
    );
    ClassDB::bind_method(
        D_METHOD("tile_get_shape", "id", "shape_id"),
    ...
    ClassDB::bind_method(
        D_METHOD("tile_get_shape_offset", "id", "shape_id"),
    ...
    ClassDB::bind_method(
        D_METHOD("tile_get_shape_transform", "id", "shape_id"),
    ...
    ClassDB::bind_method(
        D_METHOD("tile_get_shape_one_way", "id", "shape_id"),
    ...
    ClassDB::bind_method(
        D_METHOD("tile_get_shape_count", "id"),
        &TileSet::tile_get_shape_count
    );
    ClassDB::bind_method(
        D_METHOD("tile_set_shapes", "id", "shapes"),
        &TileSet::_tile_set_shapes
    );
    ClassDB::bind_method(
        D_METHOD("tile_get_shapes", "id"),
        &TileSet::_tile_get_shapes
    );
    ClassDB::bind_method(
        D_METHOD("tile_set_tile_mode", "id", "tilemode"),
        &TileSet::tile_set_tile_mode
    );
    ClassDB::bind_method(
        D_METHOD("tile_get_tile_mode", "id"),
    ...
    ClassDB::bind_method(
        D_METHOD("tile_get_navigation_polygon", "id"),
    ...
    ClassDB::bind_method(
        D_METHOD("tile_get_navigation_polygon_offset", "id"),
    ...
    ClassDB::bind_method(
        D_METHOD("tile_get_light_occluder", "id"),
    ...
    ClassDB::bind_method(
        D_METHOD("tile_get_occluder_offset", "id"),
        &TileSet::tile_get_occluder_offset
    );
    ClassDB::bind_method(
        D_METHOD("tile_set_z_index", "id", "z_index"),
        &TileSet::tile_set_z_index
    );
    ClassDB::bind_method(
        D_METHOD("tile_get_z_index", "id"),
    ...
    ClassDB::bind_method(
        D_METHOD("get_last_unused_tile_id"),
        &TileSet::get_last_unused_tile_id
    );
    ClassDB::bind_method(
        D_METHOD("find_tile_by_name", "name"),
