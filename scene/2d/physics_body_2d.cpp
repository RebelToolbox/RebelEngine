...
Array PhysicsBody2D::get_collision_exceptions() {
    List<RID> exceptions;
    Physics2DServer::get_singleton()->body_get_collision_exceptions(
        get_rid(),
        &exceptions
    );
    Array ret;
...
void PhysicsBody2D::add_collision_exception_with(Node* p_node) {
    ...
    ERR_FAIL_COND_MSG(
        !physics_body,
        "Collision exception only works between two objects of PhysicsBody "
        "type."
    );
    Physics2DServer::get_singleton()->body_add_collision_exception(
        get_rid(),
...
void PhysicsBody2D::remove_collision_exception_with(Node* p_node) {
    ...
    Physics2DServer::get_singleton()->body_remove_collision_exception(
        get_rid(),
        physics_body->get_rid()
    );
}
...
void StaticBody2D::set_constant_linear_velocity(const Vector2& p_vel) {
    ...
    Physics2DServer::get_singleton()->body_set_state(
        get_rid(),
        Physics2DServer::BODY_STATE_LINEAR_VELOCITY,
...
void StaticBody2D::set_constant_angular_velocity(real_t p_vel) {
    ...
    Physics2DServer::get_singleton()->body_set_state(
        get_rid(),
        Physics2DServer::BODY_STATE_ANGULAR_VELOCITY,
...
void StaticBody2D::_bind_methods() {
    ...
    ADD_PROPERTY(
        PropertyInfo(Variant::VECTOR2, "constant_linear_velocity"),
        "set_constant_linear_velocity",
        "get_constant_linear_velocity"
    );
    ADD_PROPERTY(
        PropertyInfo(Variant::REAL, "constant_angular_velocity"),
...
void StaticBody2D::_reload_physics_characteristics() {
    if (physics_material_override.is_null()) {
        Physics2DServer::get_singleton()
            ->body_set_param(get_rid(), Physics2DServer::BODY_PARAM_BOUNCE, 0);
        Physics2DServer::get_singleton()->body_set_param(
            get_rid(),
...
bool RigidBody2D::_test_motion(
    ...
    bool colliding = Physics2DServer::get_singleton()->body_test_motion(
        get_rid(),
...
void RigidBody2D::_direct_state_changed(Object* p_state) {
    ...
    ERR_FAIL_COND_MSG(
        ...
        "Physics2DDirectBodyState object as argument"
    );
...
void RigidBody2D::set_mode(Mode p_mode) {
    ...
    switch (p_mode) {
        case MODE_RIGID: {
            Physics2DServer::get_singleton()->body_set_mode(
                get_rid(),
        ...
        case MODE_CHARACTER: {
            Physics2DServer::get_singleton()->body_set_mode(
                get_rid(),
                Physics2DServer::BODY_MODE_CHARACTER
            );
...
void RigidBody2D::set_mass(real_t p_mass) {
    ...
    Physics2DServer::get_singleton()
        ->body_set_param(get_rid(), Physics2DServer::BODY_PARAM_MASS, mass);
}
...
void RigidBody2D::set_inertia(real_t p_inertia) {
    ...
    Physics2DServer::get_singleton()->body_set_param(
        get_rid(),
        Physics2DServer::BODY_PARAM_INERTIA,
        p_inertia
    );
}

real_t RigidBody2D::get_inertia() const {
    return Physics2DServer::get_singleton()->body_get_param(
        get_rid(),
        Physics2DServer::BODY_PARAM_INERTIA
    );
}
...
void RigidBody2D::set_weight(real_t p_weight) {
    set_mass(
        p_weight / (real_t(GLOBAL_DEF("physics/2d/default_gravity", 98)) / 10)
    );
}
...
void RigidBody2D::set_linear_damp(real_t p_linear_damp) {
    ...
    Physics2DServer::get_singleton()->body_set_param(
        get_rid(),
        Physics2DServer::BODY_PARAM_LINEAR_DAMP,
        linear_damp
    );
}
...
void RigidBody2D::set_angular_damp(real_t p_angular_damp) {
    ...
    Physics2DServer::get_singleton()->body_set_param(
        get_rid(),
        Physics2DServer::BODY_PARAM_ANGULAR_DAMP,
        angular_damp
    );
}
...
void RigidBody2D::set_axis_velocity(const Vector2& p_axis) {
    ...
    if (state) {
        ...
        Physics2DServer::get_singleton()->body_set_axis_velocity(
            get_rid(),
            p_axis
        );
        linear_velocity = v;
...
void RigidBody2D::set_use_custom_integrator(bool p_enable) {
    ...
    Physics2DServer::get_singleton()->body_set_omit_force_integration(
        get_rid(),
        p_enable
    );
}
...
void RigidBody2D::set_sleeping(bool p_sleeping) {
    ...
    Physics2DServer::get_singleton()->body_set_state(
        get_rid(),
        Physics2DServer::BODY_STATE_SLEEPING,
        sleeping
    );
}
...
void RigidBody2D::set_can_sleep(bool p_active) {
    ...
    Physics2DServer::get_singleton()->body_set_state(
        get_rid(),
        Physics2DServer::BODY_STATE_CAN_SLEEP,
        p_active
    );
}
...
void RigidBody2D::set_max_contacts_reported(int p_amount) {
    ...
    Physics2DServer::get_singleton()->body_set_max_contacts_reported(
        get_rid(),
        p_amount
    );
}
...
void RigidBody2D::apply_central_impulse(const Vector2& p_impulse) {
    Physics2DServer::get_singleton()->body_apply_central_impulse(
        get_rid(),
        p_impulse
    );
}

void RigidBody2D::apply_impulse(
    const Vector2& p_offset,
    const Vector2& p_impulse
) {
    Physics2DServer::get_singleton()
        ->body_apply_impulse(get_rid(), p_offset, p_impulse);
}

void RigidBody2D::apply_torque_impulse(float p_torque) {
    Physics2DServer::get_singleton()->body_apply_torque_impulse(
        get_rid(),
        p_torque
    );
}
...
void RigidBody2D::set_applied_force(const Vector2& p_force) {
    Physics2DServer::get_singleton()->body_set_applied_force(
        get_rid(),
        p_force
    );
};
...
void RigidBody2D::set_applied_torque(const float p_torque) {
    Physics2DServer::get_singleton()->body_set_applied_torque(
        get_rid(),
        p_torque
    );
};
...
void RigidBody2D::add_central_force(const Vector2& p_force) {
    Physics2DServer::get_singleton()->body_add_central_force(
        get_rid(),
        p_force
    );
}
...
void RigidBody2D::add_force(const Vector2& p_offset, const Vector2& p_force) {
    Physics2DServer::get_singleton()
        ->body_add_force(get_rid(), p_offset, p_force);
}
...
String RigidBody2D::get_configuration_warning() const {
    ...
    if ((get_mode() == MODE_RIGID || get_mode() == MODE_CHARACTER)
        && (ABS(t.elements[0].length() - 1.0) > 0.05
            || ABS(t.elements[1].length() - 1.0) > 0.05)) {
        if (warning != String()) {
            warning += "\n\n";
        }
        warning += TTR(
            "Size changes to RigidBody2D (in character or rigid modes) will be "
            "overridden by the physics engine when running.\nChange the size "
...
void RigidBody2D::_bind_methods() {
    ...
    ClassDB::bind_method(
        D_METHOD("set_continuous_collision_detection_mode", "mode"),
        &RigidBody2D::set_continuous_collision_detection_mode
    );
    ClassDB::bind_method(
        D_METHOD("get_continuous_collision_detection_mode"),
    ...
    ClassDB::bind_method(
        D_METHOD("apply_torque_impulse", "torque"),
        &RigidBody2D::apply_torque_impulse
    );

    ClassDB::bind_method(
        D_METHOD("set_applied_force", "force"),
        &RigidBody2D::set_applied_force
    );
    ClassDB::bind_method(
        D_METHOD("get_applied_force"),
        &RigidBody2D::get_applied_force
    );

    ClassDB::bind_method(
        D_METHOD("set_applied_torque", "torque"),
        &RigidBody2D::set_applied_torque
    );
    ClassDB::bind_method(
        D_METHOD("get_applied_torque"),
    ...
    ClassDB::bind_method(
        ...
        &RigidBody2D::_body_enter_tree
    );
    ClassDB::bind_method(
        D_METHOD("_body_exit_tree"),
        &RigidBody2D::_body_exit_tree
    );
    ...
    ADD_PROPERTY(
        PropertyInfo(Variant::VECTOR2, "applied_force"),
        "set_applied_force",
        "get_applied_force"
    );
    ADD_PROPERTY(
        PropertyInfo(Variant::REAL, "applied_torque"),
        "set_applied_torque",
        "get_applied_torque"
    );
...
Ref<KinematicCollision2D> KinematicBody2D::_move(
    const Vector2& p_motion,
    bool p_infinite_inertia,
...
bool KinematicBody2D::separate_raycast_shapes(
    bool p_infinite_inertia,
    ...
    Vector2 recover;
    int hits = Physics2DServer::get_singleton()->body_test_ray_separation(
        get_rid(),
        gt,
        p_infinite_inertia,
        recover,
...
Vector2 KinematicBody2D::_move_and_slide_internal(
    ...
    if (on_floor && on_floor_body.is_valid()) {
        ...
        Physics2DDirectBodyState* bs =
            Physics2DServer::get_singleton()->body_get_direct_state(
                on_floor_body
            );
        if (bs) {
            Transform2D gt = get_global_transform();
            Vector2 local_position =
                gt.elements[2] - bs->get_transform().elements[2];
    ...
    for (int iteration = 0; iteration < p_max_slides; ++iteration) {
        ...
        for (int i = 0; i < 2; ++i) {
            ...
            if (i == 0) { // collide
                ...
                if (!collided) {
                    motion = Vector2(); // clear because no collision happened
                ...
                if (on_floor && p_stop_on_slope) {
                    if ((body_velocity_normal + up_direction).length() < 0.01) {
                        ...
                        if (collision.travel.length() > margin) {
                            gt.elements[2] -=
                                collision.travel.slide(up_direction);
                        } else {
                ...
                if (Math::acos(col.normal.dot(up_direction))
                    ...
                    if (p_stop_on_slope) {
                        ...
                        if (col.travel.length() > margin) {
                            col.travel =
                                up_direction * up_direction.dot(col.travel);
                        } else {
                            col.travel = Vector2();
                        }
                    }
...
Vector2 KinematicBody2D::move_and_slide(
    const Vector2& p_linear_velocity,
    const Vector2& p_up_direction,
    bool p_stop_on_slope,
    int p_max_slides,
...
void KinematicBody2D::_set_collision_direction(
...
bool KinematicBody2D::test_move(
...
KinematicBody2D::Collision KinematicBody2D::get_slide_collision(int p_bounce
) const {
...
void KinematicBody2D::_direct_state_changed(Object* p_state) {
    ...
    Physics2DDirectBodyState* state =
        Object::cast_to<Physics2DDirectBodyState>(p_state);
    ERR_FAIL_COND_MSG(
        !state,
        "Method '_direct_state_changed' must receive a valid "
        "Physics2DDirectBodyState object as argument"
...
void KinematicBody2D::_bind_methods() {
    ...
    ClassDB::bind_method(
        ...
        &KinematicBody2D::get_floor_angle,
        DEFVAL(Vector2(0.0, -1.0))
    );
    ClassDB::bind_method(
    ...
    ClassDB::bind_method(
        ...
        &KinematicBody2D::set_safe_margin
    );
    ClassDB::bind_method(
        D_METHOD("get_safe_margin"),
        &KinematicBody2D::get_safe_margin
    );
    ...
    ClassDB::bind_method(
        ...
        &KinematicBody2D::_get_slide_collision
    );
    ClassDB::bind_method(
        D_METHOD("get_last_slide_collision"),
        &KinematicBody2D::_get_last_slide_collision
    );

    ClassDB::bind_method(
        D_METHOD("set_sync_to_physics", "enable"),
        &KinematicBody2D::set_sync_to_physics
    );
    ClassDB::bind_method(
        D_METHOD("is_sync_to_physics_enabled"),
        &KinematicBody2D::is_sync_to_physics_enabled
    );
...
void KinematicCollision2D::_bind_methods() {
    ...
    ClassDB::bind_method(
        ...
        &KinematicCollision2D::get_collider_rid
    );
    ClassDB::bind_method(
    ...
    ClassDB::bind_method(
        ...
        &KinematicCollision2D::get_collider_metadata
    );
    ...
    ADD_PROPERTY(
        PropertyInfo(Variant::VECTOR2, "remainder"),
        "",
        "get_remainder"
    );
    ADD_PROPERTY(
