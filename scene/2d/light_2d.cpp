...
void Light2D::_update_light_visibility() {
    ...
    VS::get_singleton()->canvas_light_set_enabled(
        canvas_light,
        enabled && is_visible_in_tree() && editor_ok
    );
}
...
void Light2D::set_texture(const Ref<Texture>& p_texture) {
    texture = p_texture;
    if (texture.is_valid()) {
        VS::get_singleton()->canvas_light_set_texture(
            canvas_light,
            texture->get_rid()
        );
    } else {
...
void Light2D::set_texture_offset(const Vector2& p_offset) {
    ...
    VS::get_singleton()->canvas_light_set_texture_offset(
        canvas_light,
        texture_offset
    );
    item_rect_changed();
...
void Light2D::set_layer_range_min(int p_min_layer) {
    ...
    VS::get_singleton()
        ->canvas_light_set_layer_range(canvas_light, layer_min, layer_max);
}
...
void Light2D::set_item_cull_mask(int p_mask) {
    item_mask = p_mask;
    VS::get_singleton()->canvas_light_set_item_cull_mask(
        canvas_light,
        item_mask
    );
}
...
void Light2D::set_item_shadow_cull_mask(int p_mask) {
    ...
    VS::get_singleton()->canvas_light_set_item_shadow_cull_mask(
        canvas_light,
        item_shadow_mask
    );
}
...
void Light2D::set_mode(Mode p_mode) {
    mode = p_mode;
    VS::get_singleton()->canvas_light_set_mode(
        canvas_light,
...
void Light2D::set_shadow_buffer_size(int p_size) {
    ...
    VS::get_singleton()->canvas_light_set_shadow_buffer_size(
        canvas_light,
        shadow_buffer_size
    );
}
...
void Light2D::set_shadow_gradient_length(float p_multiplier) {
    ...
    VS::get_singleton()->canvas_light_set_shadow_gradient_length(
        canvas_light,
        p_multiplier
    );
}
...
void Light2D::set_shadow_filter(ShadowFilter p_filter) {
    ...
    VS::get_singleton()->canvas_light_set_shadow_filter(
        canvas_light,
...
void Light2D::set_shadow_color(const Color& p_shadow_color) {
    ...
    VS::get_singleton()->canvas_light_set_shadow_color(
        canvas_light,
        shadow_color
    );
}
...
void Light2D::_notification(int p_what) {
    if (p_what == NOTIFICATION_ENTER_TREE) {
        VS::get_singleton()->canvas_light_attach_to_canvas(
            canvas_light,
            get_canvas()
        );
        _update_light_visibility();
    ...
    if (p_what == NOTIFICATION_TRANSFORM_CHANGED) {
        VS::get_singleton()->canvas_light_set_transform(
            canvas_light,
...
String Light2D::get_configuration_warning() const {
    ...
    if (!texture.is_valid()) {
        ...
        warning +=
            TTR("A texture with the shape of the light must be supplied to the "
                "\"Texture\" property.");
    }
...
void Light2D::set_shadow_smooth(float p_amount) {
    ...
    VS::get_singleton()->canvas_light_set_shadow_smooth(
        canvas_light,
        shadow_smooth
    );
}
...
void Light2D::_bind_methods() {
    ...
    ClassDB::bind_method(
        D_METHOD("set_editor_only", "editor_only"),
    ...
    ClassDB::bind_method(
        D_METHOD("set_texture_offset", "texture_offset"),
        &Light2D::set_texture_offset
    );
    ClassDB::bind_method(
        D_METHOD("get_texture_offset"),
    ...
    ClassDB::bind_method(
        D_METHOD("set_texture_scale", "texture_scale"),
        &Light2D::set_texture_scale
    );
    ClassDB::bind_method(
        D_METHOD("get_texture_scale"),
        &Light2D::get_texture_scale
    );

    ClassDB::bind_method(
        D_METHOD("set_z_range_min", "z"),
        &Light2D::set_z_range_min
    );
    ClassDB::bind_method(
        D_METHOD("get_z_range_min"),
        &Light2D::get_z_range_min
    );

    ClassDB::bind_method(
        D_METHOD("set_z_range_max", "z"),
        &Light2D::set_z_range_max
    );
    ClassDB::bind_method(
        D_METHOD("get_z_range_max"),
        &Light2D::get_z_range_max
    );

    ClassDB::bind_method(
        D_METHOD("set_layer_range_min", "layer"),
        &Light2D::set_layer_range_min
    );
    ClassDB::bind_method(
        D_METHOD("get_layer_range_min"),
        &Light2D::get_layer_range_min
    );

    ClassDB::bind_method(
        D_METHOD("set_layer_range_max", "layer"),
        &Light2D::set_layer_range_max
    );
    ClassDB::bind_method(
        D_METHOD("get_layer_range_max"),
        &Light2D::get_layer_range_max
    );

    ClassDB::bind_method(
        D_METHOD("set_item_cull_mask", "item_cull_mask"),
        &Light2D::set_item_cull_mask
    );
    ClassDB::bind_method(
        D_METHOD("get_item_cull_mask"),
        &Light2D::get_item_cull_mask
    );

    ClassDB::bind_method(
        D_METHOD("set_item_shadow_cull_mask", "item_shadow_cull_mask"),
        &Light2D::set_item_shadow_cull_mask
    );
    ClassDB::bind_method(
        D_METHOD("get_item_shadow_cull_mask"),
    ...
    ClassDB::bind_method(
        D_METHOD("set_shadow_enabled", "enabled"),
        &Light2D::set_shadow_enabled
    );
    ClassDB::bind_method(
        D_METHOD("is_shadow_enabled"),
        &Light2D::is_shadow_enabled
    );

    ClassDB::bind_method(
        D_METHOD("set_shadow_buffer_size", "size"),
        &Light2D::set_shadow_buffer_size
    );
    ClassDB::bind_method(
        D_METHOD("get_shadow_buffer_size"),
        &Light2D::get_shadow_buffer_size
    );

    ClassDB::bind_method(
        D_METHOD("set_shadow_smooth", "smooth"),
        &Light2D::set_shadow_smooth
    );
    ClassDB::bind_method(
        D_METHOD("get_shadow_smooth"),
        &Light2D::get_shadow_smooth
    );

    ClassDB::bind_method(
        D_METHOD("set_shadow_gradient_length", "multiplier"),
        &Light2D::set_shadow_gradient_length
    );
    ClassDB::bind_method(
        D_METHOD("get_shadow_gradient_length"),
        &Light2D::get_shadow_gradient_length
    );

    ClassDB::bind_method(
        D_METHOD("set_shadow_filter", "filter"),
        &Light2D::set_shadow_filter
    );
    ClassDB::bind_method(
        D_METHOD("get_shadow_filter"),
        &Light2D::get_shadow_filter
    );

    ClassDB::bind_method(
        D_METHOD("set_shadow_color", "shadow_color"),
    ...
    ADD_PROPERTY(
        PropertyInfo(
            ...
            "range_height",
            PROPERTY_HINT_RANGE,
            "-2048,2048,0.1,or_lesser,or_greater"
        ),
        "set_height",
        "get_height"
    );
    ...
    ADD_PROPERTY(
        PropertyInfo(Variant::BOOL, "shadow_enabled"),
        "set_shadow_enabled",
        "is_shadow_enabled"
    );
    ADD_PROPERTY(
    ...
    ADD_PROPERTY(
        PropertyInfo(
            ...
            "shadow_filter",
            PROPERTY_HINT_ENUM,
            "None,PCF3,PCF5,PCF7,PCF9,PCF13"
        ),
        "set_shadow_filter",
        "get_shadow_filter"
    );
