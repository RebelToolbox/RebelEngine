...
// For flow control checking, we want an easy way to apply asserts that occur in
// debug development builds only. This is enforced by outputting a warning which
// will fail CI checks if the define is set in a PR.
#if defined(TOOLS_ENABLED) && defined(DEBUG_ENABLED)
// only uncomment this define for error checking in development, not in the main
// repository as these checks will slow things down in debug builds.
