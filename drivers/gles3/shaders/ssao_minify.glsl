...
void main() {
    ...
    // Rotated grid subsampling to avoid XY directional bias or Z precision bias
    // while downsampling. On DX9, the bit-and can be implemented with
    // floating-point modulo

#ifdef MINIFY_START
    float fdepth = texelFetch(
                       source_depth,
                       clamp(
    ...
    fdepth =
        ...
        / 2.0;
#else
    fdepth = 2.0 * camera_z_near * camera_z_far
           / (camera_z_far + camera_z_near
