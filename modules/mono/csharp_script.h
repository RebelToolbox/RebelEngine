...
public:
    ...
    /* TODO? */ virtual int find_function(
    ...
    /* TODO? */ virtual void auto_indent_code(
        String& p_code,
        int p_from_line,
        int p_to_line
    ) const {}

    /* TODO */ virtual void add_global_constant(
    ...
    /* TODO */ virtual void debug_get_stack_level_locals(
        int p_level,
    ...
    /* TODO */ virtual void debug_get_stack_level_members(
        int p_level,
    ...
    /* TODO */ virtual void debug_get_globals(
        List<String>* p_locals,
        List<Variant>* p_values,
        int p_max_subitems,
        int p_max_depth
    ...
    /* TODO */ virtual String debug_parse_stack_level_expression(
        int p_level,
    ...
    /* TODO */ virtual int profiling_get_accumulated_data(
    ...
    /* TODO? */ virtual void get_public_functions(List<MethodInfo>* p_functions
    ) const {}

    /* TODO? */ virtual void get_public_constants(
