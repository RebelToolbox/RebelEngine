...
namespace Rebel
{
    ...
    public static class StringExtensions
    {
        ...
        {
            return rebel_icall_String_md5_buffer(instance);
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern byte[] rebel_icall_String_md5_buffer(string str);
        ...
        {
            return rebel_icall_String_md5_text(instance);
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern string rebel_icall_String_md5_text(string str);
        ...
        {
            return rebel_icall_String_rfind(instance, what, from);
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern int rebel_icall_String_rfind(string str, string what, int from);
        ...
        {
            return rebel_icall_String_rfindn(instance, what, from);
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern int rebel_icall_String_rfindn(string str, string what, int from);
        ...
        {
            return rebel_icall_String_sha256_buffer(instance);
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern byte[] rebel_icall_String_sha256_buffer(string str);
        ...
        {
            return rebel_icall_String_sha256_text(instance);
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern string rebel_icall_String_sha256_text(string str);
        ...
        {
            return rebel_icall_String_simplify_path(instance);
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern string rebel_icall_String_simplify_path(string str);
