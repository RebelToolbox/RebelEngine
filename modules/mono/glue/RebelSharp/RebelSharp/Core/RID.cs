...
namespace Rebel
{
    ...
    public sealed partial class RID : IDisposable
    {
        ...
        {
            this.ptr = rebel_icall_RID_Ctor(Object.GetPtr(from));
        }
        ...
        public int GetId()
        {
            return rebel_icall_RID_get_id(GetPtr(this));
        }
        ...
        internal static extern IntPtr rebel_icall_RID_Ctor(IntPtr from);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void rebel_icall_RID_Dtor(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern int rebel_icall_RID_get_id(IntPtr ptr);
    }
}
