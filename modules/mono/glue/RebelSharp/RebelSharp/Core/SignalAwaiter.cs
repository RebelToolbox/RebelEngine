...
namespace Rebel
{
    public class SignalAwaiter : IAwaiter<object[]>, IAwaitable<object[]>
    {
        ...
        {
            rebel_icall_SignalAwaiter_connect(Object.GetPtr(source), signal, Object.GetPtr(target), this);
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern Error rebel_icall_SignalAwaiter_connect(IntPtr source, string signal, IntPtr target, SignalAwaiter awaiter);
