...
namespace Rebel
{
    ...
    public static partial class GD
    {
        ...
        {
            return rebel_icall_GD_bytes2var(bytes, allowObjects);
        }
        ...
        {
            return rebel_icall_GD_convert(what, type);
        }
        ...
        [Obsolete("DecTime has been deprecated and will be removed in Rebel 4.0, use Mathf.MoveToward instead.")]
        ...
        {
            return rebel_icall_GD_hash(var);
        }
        ...
        {
            return rebel_icall_GD_instance_from_id(instanceId);
        }
        ...
        /// <summary>
        /// Pushes an error message to Rebel's built-in debugger and to the OS terminal.
        ///
        ...
        {
            rebel_icall_GD_pusherror(message);
        }

        /// <summary>
        /// Pushes a warning message to Rebel's built-in debugger and to the OS terminal.
        /// </summary>
        /// <example>
        ...
        {
            rebel_icall_GD_pushwarning(message);
        }
        ...
        {
            rebel_icall_GD_print(GetPrintParams(what));
        }
        ...
        {
            rebel_icall_GD_printerr(GetPrintParams(what));
        }
        ...
        ///
        /// Note: Due to limitations with Rebel's built-in console, this only prints to the terminal.
        ...
        {
            rebel_icall_GD_printraw(GetPrintParams(what));
        }
        ...
        {
            rebel_icall_GD_prints(GetPrintParams(what));
        }
        ...
        {
            rebel_icall_GD_printt(GetPrintParams(what));
        }
        ...
        {
            return rebel_icall_GD_rand_range(from, to);
        }
        ...
        {
            return rebel_icall_GD_rand_seed(seed, out newSeed);
        }
        ...
        {
            return rebel_icall_GD_str(what);
        }
        ...
        /// <code>
        /// string a = "{\"a\": 1, \"b\": 2 }";
        /// var b = (Rebel.Collections.Dictionary)GD.Str2Var(a);
        ...
        {
            return rebel_icall_GD_str2var(str);
        }
        ...
        {
            return rebel_icall_GD_type_exists(type);
        }
        ...
        {
            return rebel_icall_GD_var2bytes(var, fullObjects);
        }
        ...
        /// <example>
        /// <code>
        /// var a = new Rebel.Collections.Dictionary { ["a"] = 1, ["b"] = 2 };
        ...
        {
            return rebel_icall_GD_var2str(var);
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern object rebel_icall_GD_bytes2var(byte[] bytes, bool allowObjects);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern object rebel_icall_GD_convert(object what, Variant.Type type);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern int rebel_icall_GD_hash(object var);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern Object rebel_icall_GD_instance_from_id(ulong instanceId);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void rebel_icall_GD_print(object[] what);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void rebel_icall_GD_printerr(object[] what);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void rebel_icall_GD_printraw(object[] what);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void rebel_icall_GD_prints(object[] what);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void rebel_icall_GD_printt(object[] what);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern float rebel_icall_GD_randf();

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern uint rebel_icall_GD_randi();

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void rebel_icall_GD_randomize();

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern double rebel_icall_GD_rand_range(double from, double to);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern uint rebel_icall_GD_rand_seed(ulong seed, out ulong newSeed);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void rebel_icall_GD_seed(ulong seed);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern string rebel_icall_GD_str(object[] what);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern object rebel_icall_GD_str2var(string str);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern bool rebel_icall_GD_type_exists(string type);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern byte[] rebel_icall_GD_var2bytes(object what, bool fullObjects);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern string rebel_icall_GD_var2str(object var);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void rebel_icall_GD_pusherror(string type);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void rebel_icall_GD_pushwarning(string type);
    }
}
