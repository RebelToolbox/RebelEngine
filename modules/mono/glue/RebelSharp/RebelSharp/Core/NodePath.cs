...
namespace Rebel
{
    ...
    public sealed partial class NodePath : IDisposable
    {
        ...
        {
            ptr = rebel_icall_NodePath_Ctor(path);
        }
        ...
        {
            return rebel_icall_NodePath_operator_String(NodePath.GetPtr(from));
        }
        ...
        {
            return new NodePath(rebel_icall_NodePath_get_as_property_path(NodePath.GetPtr(this)));
        }
        ...
        {
            return rebel_icall_NodePath_get_concatenated_subnames(NodePath.GetPtr(this));
        }
        ...
        {
            return rebel_icall_NodePath_get_name(NodePath.GetPtr(this), idx);
        }
        ...
        {
            return rebel_icall_NodePath_get_name_count(NodePath.GetPtr(this));
        }
        ...
        {
            return rebel_icall_NodePath_get_subname(NodePath.GetPtr(this), idx);
        }
        ...
        {
            return rebel_icall_NodePath_get_subname_count(NodePath.GetPtr(this));
        }
        ...
        {
            return rebel_icall_NodePath_is_absolute(NodePath.GetPtr(this));
        }
        ...
        public bool IsEmpty()
        {
            return rebel_icall_NodePath_is_empty(NodePath.GetPtr(this));
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern IntPtr rebel_icall_NodePath_Ctor(string path);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern void rebel_icall_NodePath_Dtor(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern string rebel_icall_NodePath_operator_String(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern IntPtr rebel_icall_NodePath_get_as_property_path(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern string rebel_icall_NodePath_get_concatenated_subnames(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern string rebel_icall_NodePath_get_name(IntPtr ptr, int arg1);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern int rebel_icall_NodePath_get_name_count(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern string rebel_icall_NodePath_get_subname(IntPtr ptr, int arg1);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern int rebel_icall_NodePath_get_subname_count(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern bool rebel_icall_NodePath_is_absolute(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern bool rebel_icall_NodePath_is_empty(IntPtr ptr);
    }
}
