...
namespace RebelTools.Build
{
    public static class BuildSystem
    {
        ...
        private static Rebel.EditorSettings EditorSettings =>
            RebelSharpEditor.Instance.GetEditorInterface().GetEditorSettings();
        ...
        private static string BuildArguments(BuildTool buildTool, BuildInfo buildInfo)
        {
            ...
            arguments += $@" /t:{string.Join(",", buildInfo.Targets)} " +
                         ...
                         $@"""/l:{typeof(RebelBuildLogger).FullName},{RebelBuildLogger.AssemblyPath};{buildInfo.LogsDirPath}""";
