...
namespace RebelTools.Build
{
    public static class MsBuildFinder
    {
        ...
        private static string FindMsBuildToolsPathOnWindows()
        {
            ...
            string[] envNames = Internal.RebelIs32Bits() ?
            ...
            var outputArray = new Rebel.Collections.Array<string>();
            int exitCode = Rebel.OS.Execute(vsWherePath, vsWhereArgs,
                blocking: true, output: (Rebel.Collections.Array)outputArray);
