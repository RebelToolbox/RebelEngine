...
namespace RebelTools.BuildLogger
{
    public class RebelBuildLogger : ILogger
    {
        public static readonly string AssemblyPath = Path.GetFullPath(typeof(RebelBuildLogger).Assembly.Location);
