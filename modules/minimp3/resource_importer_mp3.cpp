...
void ResourceImporterMP3::get_recognized_extensions(List<String>* p_extensions
) const {
...
bool ResourceImporterMP3::get_option_visibility(
...
Error ResourceImporterMP3::import(
