...
typedef enum {
    ...
    GODOT_PROPERTY_HINT_RANGE, ///< hint_text = "min,max,step,slider; //slider
                               ///< is optional"
    GODOT_PROPERTY_HINT_EXP_RANGE,  ///< hint_text = "min,max,step", exponential
                                    ///< edit
    ...
    GODOT_PROPERTY_HINT_SPRITE_FRAME, // FIXME: Obsolete: drop whenever we can
                                      // break compat
    ...
    GODOT_PROPERTY_HINT_FILE, ///< a file path must be passed, hint_text
                              ///< (optionally) is a filter "*.png,*.wav,*.doc,"
    GODOT_PROPERTY_HINT_DIR,  ///< a directory path must be passed
    GODOT_PROPERTY_HINT_GLOBAL_FILE, ///< a file path must be passed, hint_text
    ...
    GODOT_PROPERTY_HINT_MULTILINE_TEXT, ///< used for string properties that can
                                        ///< contain multiple lines
    GODOT_PROPERTY_HINT_PLACEHOLDER_TEXT, ///< used to set a placeholder text
                                          ///< for string properties
    GODOT_PROPERTY_HINT_COLOR_NO_ALPHA,   ///< used for ignoring alpha component
    ...
    GODOT_PROPERTY_HINT_TYPE_STRING, ///< a type string, the hint is the base
                                     ///< type to choose
    GODOT_PROPERTY_HINT_NODE_PATH_TO_EDITED_NODE, ///< so something else can
...
typedef enum {
    ...
    GODOT_PROPERTY_USAGE_DEFAULT = GODOT_PROPERTY_USAGE_STORAGE
                                 | GODOT_PROPERTY_USAGE_EDITOR
                                 | GODOT_PROPERTY_USAGE_NETWORK,
    GODOT_PROPERTY_USAGE_DEFAULT_INTL =
        GODOT_PROPERTY_USAGE_STORAGE | GODOT_PROPERTY_USAGE_EDITOR
        | GODOT_PROPERTY_USAGE_NETWORK | GODOT_PROPERTY_USAGE_INTERNATIONALIZED,
    GODOT_PROPERTY_USAGE_NOEDITOR =
        GODOT_PROPERTY_USAGE_STORAGE | GODOT_PROPERTY_USAGE_NETWORK,
...
void GDAPI
godot_nativescript_profiling_add_data(const char* p_signature, uint64_t p_time);
