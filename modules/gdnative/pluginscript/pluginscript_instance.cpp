...
Variant::Type PluginScriptInstance::get_property_type(
    const StringName& p_name,
    bool* r_is_valid
) const {
...
void PluginScriptInstance::get_property_list(List<PropertyInfo>* p_properties
) const {
...
Variant PluginScriptInstance::call(
...
MultiplayerAPI::RPCMode PluginScriptInstance::get_rpc_mode(
    const StringName& p_method
) const {
    return _script->get_rpc_mode(p_method);
}

MultiplayerAPI::RPCMode PluginScriptInstance::get_rset_mode(
