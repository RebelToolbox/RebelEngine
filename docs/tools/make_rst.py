...
def make_rst_class(
    ...
    f.write(
        ".. Generated automatically by docs/tools/make_rst.py in Rebel Engine's source tree.\n"
    )
    f.write(
        ".. DO NOT EDIT THIS FILE, but the " + class_name + ".xml source instead.\n"
    )
    f.write(".. The source is found in docs/classes or modules/<name>/doc_classes.\n\n")
