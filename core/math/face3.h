...
public:
     ...
     * @param p_is_point_over array of at least 3 booleans, determining which
     * face is over the plane, amount used in function return
    ...
    Side get_side_of(
        const Face3& p_face,
        ClockDirection p_clock_dir = CLOCKWISE
    ) const;
    ...
    bool intersects_ray(
        ...
        const Vector3& p_dir,
        Vector3* p_intersection = nullptr
    ) const;
...
#define TEST_AXIS(m_ax)                                                        \
    {                                                                          \
        ...
        for (int i = 0; i < 3; i++) {                                          \
            if (i == 0 || vertex[i].m_ax > tri_max) tri_max = vertex[i].m_ax;  \
            if (i == 0 || vertex[i].m_ax < tri_min) tri_min = vertex[i].m_ax;  \
        }                                                                      \
                                                                               \
