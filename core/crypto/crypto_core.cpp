...
Error CryptoCore::AESContext::set_encode_key(
    const uint8_t* p_key,
    size_t p_bits
) {
...
Error CryptoCore::AESContext::set_decode_key(
    const uint8_t* p_key,
    size_t p_bits
) {
...
Error CryptoCore::AESContext::encrypt_ecb(
    const uint8_t p_src[16],
    uint8_t r_dst[16]
) {
    int ret = mbedtls_aes_crypt_ecb(
...
Error CryptoCore::AESContext::decrypt_ecb(
    const uint8_t p_src[16],
    uint8_t r_dst[16]
) {
    int ret = mbedtls_aes_crypt_ecb(
...
Error CryptoCore::AESContext::encrypt_cbc(
    size_t p_length,
    uint8_t r_iv[16],
    const uint8_t* p_src,
    uint8_t* r_dst
...
Error CryptoCore::AESContext::decrypt_cbc(
    size_t p_length,
    uint8_t r_iv[16],
    const uint8_t* p_src,
    uint8_t* r_dst
